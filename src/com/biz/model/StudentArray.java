...
public class StudentArray {
	...
	/* Student 클래스를 객체별로 생성하고
	 * 가상의 학생 성적데이터를 만들어서
	 * return하는 배열을 생성
	 */
	public Student[] makeScore(int stdLen) {

		// 숫자형 배열은 배열을 초기화하면 각개별값이 0으로 생성
		int[] intA = new int[10];
					
					// 문자열형 배열은 배열을 초기화하면 각개별값이 ""으로 생성
			String[] strA = new String[10];
		
		// Student 클래스 객체 배열 10개를 예약하라
		// 아직 예약만 되어있고 사용할 준비가 되지 않은상태
		Student[] stdScore= new Student[stdLen];
		
		// 하지만 기타 다른클래스들을 이용한
		// 객체 배열은 사용(읽기, 쓰기)전에 각 배열요소를
		// 개별적으로 초기화하는 코드를 수행해야 한다.
